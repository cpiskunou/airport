...
public class AirlineDTO {
    ...
    @Size(max = 50, groups = onCreate.class, message = "Name should be less than 50 characters")
    private String name;

    @NotNull(groups = onCreate.class, message = "IATA code should be not null")
    ...
    @NotNull(groups = onCreate.class, message = "ICAO code should be not null")
    ...
    @NotNull(groups = onCreate.class, message = "Callsign should be not null")
    @Size(max = 30, groups = onCreate.class, message = "Callsign should be less than 30 characters")
    @JsonInclude(JsonInclude.Include.NON_NULL)
